...
if(KWEFookxWQOk < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - KWEFookxWQOk] call life_fnc_numberText];};
...
/*
		if(_className == "CG_HM1") then {
		{
			[_vehicle,"CG_HM1",true] spawn life_fnc_vehicleAnimate;
		};
		if(_className == "CG_HM2") then {
		{
			[_vehicle,"CG_HM2",true] spawn life_fnc_vehicleAnimate;
		};
		if(_className == "CG_HM3") then {
		{
			[_vehicle,"CG_HM3",true] spawn life_fnc_vehicleAnimate;
		};
		if(_className == "CG_HM4") then {
		{
			[_vehicle,"CG_HM4",true] spawn life_fnc_vehicleAnimate;
		};		
*/
