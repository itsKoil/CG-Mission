...
switch (true) do {
	...
	case (_house in ["Land_i_Garage_V1_F","Land_i_Garage_V2_F"]): {[2500000,0]};
	...
	case (_house in ["Land_i_Addon_02_V1_F"]): {[1250000,1]};
	case (_house in ["Land_Slum_House01_F","Land_Slum_House03_F","Land_Slum_House02_F","Land_cargo_house_slum_F"]): {[450000,1]};
	case (_house in ["Land_Cargo_House_V1_F","Land_Cargo_House_V2_F","Land_Cargo_House_V3_F","Land_Medevac_house_V1_F","Land_Research_house_V1_F"]): {[1200000,1]};
	case (_house in ["Land_Offices_01_V1_F","Land_MilOffices_V1_F"]): {[4000000,5]};
	case (_house in ["Land_i_Shed_Ind_F"]): {[3000000,4]};
	...
	case (_house in ["Land_A_Villa_EP1"]): {[6000000,6]};
