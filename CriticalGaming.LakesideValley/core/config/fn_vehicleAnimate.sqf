	...
	else
{
	...
	/*
		case "CG_HM1":
		{
			_vehicle setobjecttextureglobal [1,"\MELB\Data\melb_ext_co2.paa"];
		};
		case "CG_HM2":
		{
			_vehicle setobjecttextureglobal [1,"\MELB\Data\melb_ext_co3.paa"];
		};
		case "CG_HM3":
		{
			_vehicle setobjecttextureglobal [1,"\MELB\Data\melb_ext_co4.paa"];
		};
		case "CG_HM4":
		{
			_vehicle setobjecttextureglobal [1,"\MELB\Data\melb_ext_co5.paa"];
		};		
		*/
		case "cop_rev":
		{
