...
{
	if(KWEFookxWQOk < _cost) exitWith {hint format[localize "STR_Process_License",[_cost] call life_fnc_numberText]; 5 cutText ["","PLAIN"]; life_is_processing = false;};
	...
	KWEFookxWQOk = KWEFookxWQOk - _cost;
	life_is_processing = false;
};	