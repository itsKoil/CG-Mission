...
[[player,"spin"],"A3L_Fnc_NearestSound",false,false,false] call BIS_fnc_MP;	
sleep 4;
...
KWEFookxWQOk = KWEFookxWQOk + _slotcash;
_winningsText ctrlSetText format["%1",_slotcash];

if(_winnings > 5000 && _winnings < 9000) then {
	[[player,"jackpot2"],"A3L_Fnc_NearestSound",false,false,false] call BIS_fnc_MP;	
	sleep 12;
};
if(_winnings > 8999 && _winnings < 19000) then {
	[[player,"jackpot1"],"A3L_Fnc_NearestSound",false,false,false] call BIS_fnc_MP;	
	sleep 12;
};
if(_winnings > 18999) then {
	[[player,"ciggy"],"A3L_Fnc_NearestSound",false,false,false] call BIS_fnc_MP;
	sleep 12;	
};
