...
if(KWEFookxWQOk < _betamt) exitWith {hint format["You don't have enough money to play (%1$)",_betamt];};
KWEFookxWQOk = KWEFookxWQOk - _betamt;
...
switch ( _betamt ) do 
{
	case 500:  { _bet10KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 1000: { _bet5KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 1200: { _bet10KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 1400: { _bet10KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; };
...
{ 
	_win = 4 * _betamt;
	KWEFookxWQOk = KWEFookxWQOk + _win;
