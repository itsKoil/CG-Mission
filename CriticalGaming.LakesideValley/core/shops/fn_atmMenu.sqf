...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='\cg_sndimg\icons\bank.paa'/> $%1<br/><img size='1.6' image='\cg_sndimg\icons\money.paa'/> $%2",[life_atmcash] call life_fnc_numberText,[KWEFookxWQOk] call life_fnc_numberText];
