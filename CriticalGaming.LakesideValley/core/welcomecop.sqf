...
_imag  = "<img image='textures\a3l.jpg' size='10' align='center'/>"; _text = format["<br/><t color='#C5B6B5' size='1.8' align='center'>Welcome %1 to CG Life!</t><br/><br/>",ProfileName];  
...
_role1 = "Welcome to";
_role1names = ["Critical Gaming"];       //Add your texts here!
_role2 = "Always be on TS";
_role2names = ["tsgb1.vilayer.com:10067"];
_role3 = "Rules";
